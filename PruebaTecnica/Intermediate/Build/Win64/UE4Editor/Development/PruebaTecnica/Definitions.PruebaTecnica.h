...
#define UE_PROJECT_NAME PruebaTecnica
#define UE_TARGET_NAME PruebaTecnicaEditor
#define UE_MODULE_NAME "PruebaTecnica"
...
#define PRUEBATECNICA_API DLLEXPORT
